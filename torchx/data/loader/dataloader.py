...
class DataLoader(object):
    ...
    def __init__(self, dataset, batch_size=1, shuffle=False,
                 ...
                 collate_fn=None, decollate_fn=None,
                 pin_memory=False, drop_last=False, timeout=0,
                 transformer=None, device=None, worker_init_fn=None,
        ...
        if decollate_fn is None:
            if self._auto_collation:
                decollate_fn = _utils.collate.default_decollate
            else:
                pass    # TODO
...
class _BaseDataLoaderIter(object):
    def __init__(self, loader):
        ...
        self._transformer = loader.transformer
        self._device = loader.device
        self._num_workers = loader.num_workers
        self._pin_memory = loader.pin_memory and torch.cuda.is_available()
        self._timeout = loader.timeout
        self._collate_fn = loader.collate_fn
        self._decollate_fn = loader.decollate_fn
    ...
    def preload_data(self):
        ...
        if self._copy_stream is None:
            # Do nothing if not on CUDA
            return

        self._data = _utils.cuda.to_cuda(self._data, self._copy_stream, self._device)
    ...
    def __next__(self):
        ...
        # NOTE: This maybe useless for us, but I don't know.
        # Because this API is poorly documented.
        # See: https://github.com/pytorch/pytorch/issues/23729
        _utils.cuda.record_stream(self._data, torch.cuda.current_stream())
        ...
        if self._transformer is not None:
            if self._auto_collation:
                data = list(map(self._transformer, self._decollate_fn(data)))
